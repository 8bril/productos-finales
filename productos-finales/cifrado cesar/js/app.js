var string = (prompt('Encipher your phrase')).toUpperCase(); // Pediremos al usuario ingresar una frase 
...
function caesarCipher(string){
  ...
  var strPhrase = string.split(''); // nos devolvera el array con sus elementos
  ...
  document.write('Your result of your phrase is ' + caesarCipher(string)); // imprime el resultado de la frase cifrada en pantalla